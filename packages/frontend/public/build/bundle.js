...
var app = (function () {
    ...
    const block = {
      c: function create() {
        ...
        attr_dev(
          button,
          "class",
          "text-white px-3 py-2 border rounded bg-blue-400 svelte-1d6b8gf"
        );
      ...
      m: function mount(target, anchor) {
        ...
        if (!mounted) {
          dispose = listen_dev(
            ...
            "keyup",
            function () {
              if (is_function(/*onChange*/ ctx[1]))
                /*onChange*/ ctx[1].apply(this, arguments);
            },
            false,
            false,
            false
  ...
  function instance$4($$self, $$props, $$invalidate) {
    ...
    $$self.$$set = ($$props) => {
      if ("placeholder" in $$props)
        $$invalidate(0, (placeholder = $$props.placeholder));
  ...
  function instance$5($$self, $$props, $$invalidate) {
    ...
    Object.keys($$props).forEach((key) => {
      if (!~writable_props.indexOf(key) && key.slice(0, 2) !== "$$")
        console.warn(`<FormGroup> was created with unknown prop '${key}'`);
    });
  ...
  function create_default_slot_4(ctx) {
    ...
    dispatch_dev("SvelteRegisterBlock", {
      ...
      type: "slot",
      source: "(54:6) <Button onClick={joinGame}>",
      ctx,
    });
  ...
  function create_default_slot_2(ctx) {
    ...
    const block = {
      c: function create() {
        ...
        add_location(p, file$3, 57, 6, 1415);
      },
      m: function mount(target, anchor) {
  ...
  // (62:6) <Button onClick={createGame}>
  function create_default_slot_1(ctx) {
    ...
    dispatch_dev("SvelteRegisterBlock", {
      ...
      type: "slot",
      source: "(62:6) <Button onClick={createGame}>",
      ctx,
    });
    ...
    const block = {
      c: function create() {
        ...
        attr_dev(
          div0,
          "class",
          "border-2 rounded-lg shadow flex flex-col justify-center items-center\n    w-full md:w-1/4 p-10"
        );
        add_location(div0, file$3, 34, 2, 851);
        attr_dev(
          div1,
          "class",
          "flex flex-col justify-center items-center h-screen"
        );
        add_location(div1, file$3, 33, 0, 784);
      },
      l: function claim(nodes) {
        throw new Error(
          "options.hydrate only works if the component was compiled with the `hydratable: true` option"
  ...
  function instance$6($$self, $$props, $$invalidate) {
    ...
    const joinGame = () => {
      socket.emit("JOIN_GAME", { playerName: name, code });
    };
    ...
    const writable_props = ["name", "updateName"];

    Object.keys($$props).forEach((key) => {
      if (!~writable_props.indexOf(key) && key.slice(0, 2) !== "$$")
        console.warn(`<StartPage> was created with unknown prop '${key}'`);
    });
    ...
    $$self.$$set = ($$props) => {
      ...
      if ("updateName" in $$props)
        $$invalidate(6, (updateName = $$props.updateName));
    };
  ...
  class StartPage extends SvelteComponentDev {
    constructor(options) {
      ...
      if (/*updateName*/ ctx[6] === undefined && !("updateName" in props)) {
        console.warn(
          "<StartPage> was created without expected prop 'updateName'"
        );
      }
    }
    ...
    get name() {
      throw new Error(
        "<StartPage>: Props cannot be read directly from the component instance unless compiling with 'accessors: true' or '<svelte:options accessors/>'"
      );
    }

    set name(value) {
      throw new Error(
        "<StartPage>: Props cannot be set directly on the component instance unless compiling with 'accessors: true' or '<svelte:options accessors/>'"
      );
    }
  ...
  function create_if_block$2(ctx) {
    ...
    let if_block =
      /*name*/ ctx[1] === /*game*/ ctx[0].players[0] &&
  ...
  function instance$7($$self, $$props, $$invalidate) {
    ...
    Object.keys($$props).forEach((key) => {
      if (!~writable_props.indexOf(key) && key.slice(0, 2) !== "$$")
        console.warn(`<WaitScreen> was created with unknown prop '${key}'`);
    });
    ...
    $$self.$$set = ($$props) => {
      ...
      if ("startGame" in $$props)
        $$invalidate(6, (startGame = $$props.startGame));
  ...
  class WaitScreen extends SvelteComponentDev {
    constructor(options) {
      ...
      if (/*getGame*/ ctx[5] === undefined && !("getGame" in props)) {
        console.warn(
          "<WaitScreen> was created without expected prop 'getGame'"
        );
      }

      if (/*startGame*/ ctx[6] === undefined && !("startGame" in props)) {
        console.warn(
          "<WaitScreen> was created without expected prop 'startGame'"
        );
      }
    ...
    get params() {
      throw new Error(
        "<WaitScreen>: Props cannot be read directly from the component instance unless compiling with 'accessors: true' or '<svelte:options accessors/>'"
      );
    }

    set params(value) {
      throw new Error(
        "<WaitScreen>: Props cannot be set directly on the component instance unless compiling with 'accessors: true' or '<svelte:options accessors/>'"
      );
    }
  ...
  function create_else_block$2(ctx) {
    let p;
    let t_value =
      /*game*/ ctx[0].dealtCards[/*game*/ ctx[0].lastPlayedIndex] + "";
    let t;
  ...
  function create_if_block$3(ctx) {
    ...
    dispatch_dev("SvelteRegisterBlock", {
      ...
      type: "if",
      source: "(6:2) {#if game.lastPlayedIndex === -1}",
      ctx,
    });
  ...
  function instance$8($$self, $$props, $$invalidate) {
    ...
    Object.keys($$props).forEach((key) => {
      if (!~writable_props.indexOf(key) && key.slice(0, 2) !== "$$")
        console.warn(`<PlayScreen> was created with unknown prop '${key}'`);
    });
  ...
  class PlayScreen extends SvelteComponentDev {
    constructor(options) {
      ...
      if (/*game*/ ctx[0] === undefined && !("game" in props)) {
        console.warn("<PlayScreen> was created without expected prop 'game'");
      }

      if (/*hand*/ ctx[1] === undefined && !("hand" in props)) {
        console.warn("<PlayScreen> was created without expected prop 'hand'");
      }
    }

    get game() {
      throw new Error(
        "<PlayScreen>: Props cannot be read directly from the component instance unless compiling with 'accessors: true' or '<svelte:options accessors/>'"
      );
    }

    set game(value) {
      throw new Error(
        "<PlayScreen>: Props cannot be set directly on the component instance unless compiling with 'accessors: true' or '<svelte:options accessors/>'"
      );
    }
  ...
  function create_if_block$4(ctx) {
    ...
    const block = {
      ...
      p: function update(ctx, dirty) {
        ...
        if (dirty & /*params*/ 1024)
          waitscreen_changes.params = /*params*/ ctx[10];
  ...
  function create_default_slot_2$1(ctx) {
    ...
    function select_block_type(ctx, dirty) {
      if (/*game*/ ctx[1] == null || /*game*/ ctx[1].status === "join")
        return 0;
      return 1;
    }
