...
var app = (function () {
    ...
    function instance$6($$self, $$props, $$invalidate) {
    	let { name } = $$props, { updateName } = $$props;
    ...
    class StartPage extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$6, create_fragment$6, safe_not_equal, { name: 0, updateName: 6 });
    ...
    function instance$8($$self, $$props, $$invalidate) {
    	...
    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== "$$") console.warn(`<PlayScreen> was created with unknown prop '${key}'`);
    	});
